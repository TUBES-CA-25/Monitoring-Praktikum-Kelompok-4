<div class="container">
    ...
    <input type="hidden" value="<?= e($data['ubahdata']['id_jurusan']) ?>" name="id_jurusan">
        <div class="row">
            <div class="col-12">
                <div class="form-group mb-1">
                    <label for="jurusan" class="form-label">Laboratorium</label>
                    <input type="text" name="jurusan" class="form-control " value="<?= e($data['ubahdata']['jurusan']) ?>" >
                </div>
                <div class="form-group mb-1">
                    <label for="singkatan_jurusan" class="form-label">Laboratorium</label>
                    <input type="text" name="singkatan_jurusan" class="form-control " value="<?= e($data['ubahdata']['singkatan_jurusan']) ?>" >
                </div>
                <br>
