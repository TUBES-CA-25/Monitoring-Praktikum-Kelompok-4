<div class="container">
    ...
    <input type="hidden" value="<?= e($data['ubahdata']['id_ruangan']) ?>" name="id_ruangan">
        <div class="row">
            <div class="col-12">
                <div class="form-group mb-1">
                    <label for="nama_ruangan" class="form-label">Laboratorium</label>
                    <input type="text" name="nama_ruangan" class="form-control " value="<?= e($data['ubahdata']['nama_ruangan']) ?>" >
                </div><br>
