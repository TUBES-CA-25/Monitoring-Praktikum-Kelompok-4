...
<table border="1">
    <thead>
        ...
        <tr><th colspan="10" style="text-align: center;">Mata Kuliah: <?= e($data['detail']['nama_matkul']) ?> (<?= e($data['detail']['kode_matkul']) ?>)</th></tr>
        <tr><th colspan="10" style="text-align: center;">Semester/Tahun: <?= e($data['detail']['tahun_ajaran']) ?></th></tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center"><?= e($m['tanggal']) ?></td>
            <td><?= e($m['uraian_materi']) ?></td>
            <td><?= e($m['uraian_tugas']) ?></td>
            <td align="center"><?= e($m['hadir']) ?></td>
            <td align="center"><?= e($m['alpa']) ?></td>
            ...
            <td><?= e($m['nama_asisten_pengganti']) ?></td>
        </tr>
        <?php endforeach; ?>
        <?php for ($i = $no + 1; $i <= 12; $i++): ?>
            <tr><td align="center"><?= e($i) ?></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
        <?php endfor; ?>
    </tbody>
</table>